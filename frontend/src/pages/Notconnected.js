...
export function NotConnected() {
    ...
    return (
        <div className='w-full text-white mx-auto not_connected flex flex-col items-center justify-center background'>
            ...
            <form class='flex flex-row' onSubmit={handleSumbitForm}>
                ...
                <button id='get_started_button' className='bg-red-600 py-6 px-10 flex flex-row-reverse'>
